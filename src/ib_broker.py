...
class IBTWSAPI:
    ...
    #                      right: str = ...):
    def _create_contract(self,contract: str,symbol: str,ltdocm: str,exchange: str):
        """
        ...
        #     return ContFuture(symbol=symbol,localSymbol='N225M_CONT',exchange=exchange,multiplier="100",currency="JPY")

        if contract == "future":
            return Future(symbol=symbol,lastTradeDateOrContractMonth=ltdocm,exchange=exchange)
            # return Future(symbol='N225M',lastTradeDateOrContractMonth='202503',exchange='OSE.JPN',multiplier='100',currency='JPY') # even here the local symbol is missing
